import { z } from "zod";
import { DOG_SIZES, ENERGY_LEVELS, LISTING_TYPES } from "./constants";

// All user input crossing the client/server boundary is validated
// with these schemas inside the server actions.
...
// Helper to surface the first Zod error message to the UI.
