...
import { DogIcon, EyeIcon, PencilIcon, PlusIcon, SparklesIcon } from "lucide-react";
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-5">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <p className="text-sm font-medium text-primary">For shelters, fosters & owners</p>
            ...
            return (
              <Card key={dog.id} className="group overflow-hidden border-white/80 bg-white/90 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-lg">
                <div className="relative h-56 bg-muted">
                  ...
                  <div className="absolute top-3 left-3 flex gap-1.5"><Badge>{LISTING_TYPE_LABELS[dog.listing_type]}</Badge>{!dog.is_active && <Badge variant="secondary">Hidden</Badge>}</div>
                </div>
